module.exports = class {
  static get name() { return 'CompatV4'; }
  ...
  before() {
    ...
    browser.addCommand('waitForVisible', async function (selector, timeout, reverse = false) {
        const element = await this.$(selector);
        return element.waitForVisible({ timeout, reverse });
    });
    ...
    browser.addCommand('waitForVisible', async function (timeout, reverse = false) {
      return this.waitForDisplayed({ timeout, reverse });
    }, true);
  }
